...
def show_result():
    ...
    if st.button("RE-ENTER THE ARENA"):
        ...
        # Haunted flag intentionally NOT cleared
        st.rerun()
...
if not st.session_state.name_submitted:
    ...
    # ========================================================
    # HAUNTED NAME SCREEN
    # REPLACES THE NAME BOX WITH SANS IMAGE
    # ========================================================
    ...
    if st.session_state.haunted:
        ...
        st.markdown(f"""
            ...
            <div class="haunted-name-screen">

                <img
                    src="data:image/jpeg;base64,{sansback_base64}"
                    alt="Sans"
                >
        ...
        # IMPORTANT:
        # No name input.
        # No ENTER THE ARENA button.
        # The image is the entire replacement screen.
    ...
    # No restart button on name screen
    st.stop()
...
st.markdown(
    f'THE ARENA · QUESTION {q_index + 1}',
    unsafe_allow_html=True
)
...
with col2:
    ...
    if st.button(
        ...
        # ====================================================
        # THIS NOW ONLY ACTIVATES THE HAUNTED NAME SCREEN
